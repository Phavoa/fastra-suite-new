...
export default function Page() {
  ...
  async function onSave(data: StockAdjustmentFormData): Promise<void> {
    ...
    try {
      ...
      const errorMessage = extractErrorMessage(error, "Failed to save stock adjustment. Please try again.");
  ...
  async function onValidate(data: StockAdjustmentFormData): Promise<void> {
    ...
    try {
      ...
      const errorMessage = extractErrorMessage(error, "Failed to validate stock adjustment. Please try again.");
