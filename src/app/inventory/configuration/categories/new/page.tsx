    ...
    <PageGuard application="inventory" module="productcategories">
      <div className="flex flex-col flex-1 min-h-[calc(100vh-64px)] bg-white relative pb-20">
        ...
        <div className="flex items-center px-6 py-4 border-b border-gray-100">
          ...
          <h1 className="text-lg font-medium text-gray-800">New Category</h1>
        </div>

        {/* Form Container */}
        <div className="p-6 max-w-[1400px] mx-auto w-full flex flex-col gap-10 overflow-y-auto">
          <section>
            <h2 className="text-[#3B7CED] text-xl mb-6 font-medium">Category Attributes</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col gap-2 md:col-span-3">
                ...
                <Textarea
                  placeholder="Enter detailed explanation of what this category includes..."
                  className="bg-white border-gray-300 rounded min-h-[120px]"
                  value={description}
